...
import { Settings, ShieldCheck, Lock, Trash2, Eye, Cat as CatIcon, LogOut } from 'lucide-react';
        ...
        <Card className="p-5 space-y-4 border-amber-200/80">
          <div className="flex items-center justify-between">
            ...
            <form action={handleSignOut}>
              <Button type="submit" variant="outline" size="sm" className="rounded-2xl font-bold gap-2">
